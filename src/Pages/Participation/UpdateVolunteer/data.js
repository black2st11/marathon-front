...
export const secondProps = {
	items: [
		...
		[
			{
				title: {children: '학교명'},
				content: {children: '망고 고등학교'},
				key: 'school_name',
			},
			{
				title: {children: '학년반'},
				content: {children: '2학년 3반'},
				key: 'class_name',
			},
		],
				...
				items: [
					{
						content: {
							...ulsContentProps,
							children:
								'자원봉사자는 사전에 전자메일이나 문자로 송달받은 임무 내역을 숙지하고 행사 전일 예비소집 때 반드시 참석해야 합니다.',
						},
					},
					{
						content: {
							...ulsContentProps,
							children:
								'행사 시작과 종료시 인원체크가 되어야 하며 그렇지 않을 경우 자원봉사 인정을 하지 않습니다. (당일 봉사시간 8시간)',
						},
					},
					{
						content: {
							...ulsContentProps,
							children:
								'관리자의 지시를 잘 이행해야 하며 그렇지 않을 경우 봉사 활동을 정지 시키고 귀가 조치할 수 있습니다.',
						},
					},
					{
						content: {
