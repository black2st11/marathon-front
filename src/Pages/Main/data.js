...
export const secondProps = {
    info: {
        ...
        links: [
            { img: { src: participateLogoImg }, text: { ...secondTextProps.content, children: '참가신청' } },
            { img: { src: recogLogoImg }, text: { ...secondTextProps.content, children: '접수확인' } },
            { img: { src: infoLogoImg }, text: { ...secondTextProps.content, children: '대회요강' } },
            { img: { src: recordLogoImg }, text: { ...secondTextProps.content, children: '대회기록' } },
            { img: { src: notifyLogoImg }, text: { ...secondTextProps.content, children: '공지사항' } },
        ]
    },
    supports: [
        { title: { ...secondTextProps.support, children: '주최' }, imgs: [{ src: cbsImg }] },
        { title: { ...secondTextProps.support, children: '후원' }, imgs: [{ src: gyeongSangImg }, { src: jinjuImg }] },
    ]
}
...
export const thirdProps = {
    title: {
        ...
        description: { ...thirdTextProps.description, children: '반드시 참가 유의사항을 읽고 신청해주세요.' }
    },
    first: [
        { title: { ...thirdTextProps.item.title, children: '대회명' }, contents: [{ children: `2022 대한민국 마라톤 송년\n남부내륙철도 조기착공 기원 전국마라톤대회` }] },
        {
            title: { ...thirdTextProps.item.title, children: '대회일시' },
            contents: [{ ...thirdTextProps.item.title, children: `2022년 12월 31일(토) 개회식: 13:00/출발: 13:30` }, { ...thirdTextProps.item.content, children: `13:30 하프코스 출발\n13:40 10km코스 출발\n13:50 5km코스 출발\n` }],
        },
        { title: { ...thirdTextProps.item.title, children: '집결시간' }, contents: [{ children: `해당코스 출발 30분 전 집결완료` }] },
        { title: { ...thirdTextProps.item.title, children: '장소' }, contents: [{ children: `진주역` }] },
        {
            title: { ...thirdTextProps.item.title, children: '참가구분' },
            contents: [
                { ...thirdTextProps.item.content, children: `하프/10km/5km` },
                { ...thirdTextProps.item.content, children: `3가지 코스 중 선택 가능` },
            ]
        },
    ],
    second: [
        {
            ...
            contents: [
                { ...thirdTextProps.item.content, children: `내외국인 누구나 나이제한 없으며, 신체 건강한 남녀 누구나` },
                {
        ...
        },
        {
            ...
            contents: [{ ...thirdTextProps.item.title, children: `2022년 12월 19일 (월) 18:00까지` }],
        },
        { title: { ...thirdTextProps.item.title, children: '제공품' }, contents: [{ ...thirdTextProps.item.content, children: `기념품, 배번호, 기록칩(하프, 10km), 안내책자, 그 외 필요한 물품` }] },
        { title: { ...thirdTextProps.item.title, children: '시상' }, contents: [{ ...thirdTextProps.item.content, children: `하프코스 남녀 1위 / 2위 / 3위\n10km코스 남녀 각 1위 / 2위 / 3위\n5km코스 남녀 1위 / 2위 / 3위` }] },
        {
            title: { ...thirdTextProps.item.title, children: '코스' },
            contents: [
                { ...thirdTextProps.item.content, children: `진주역 ~ 문산읍 갈곡마을 (자전거도로이용)` },
            ]
        },
    ]
}
...
export const fourthProps = {
    title: {
        ...
        description: { ...fourthTextProps.description, children: '반드시 참가 유의사항을 읽고 신청해주세요.', }
    },
    course: {
        src: courseImg,
        alt: '코스',
